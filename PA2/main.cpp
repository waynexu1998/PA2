...
int main(int argc, char **argv)
{
    ...
    for (uint32_t i = 0; i < numVertices; ++i) {
        ...
        uint32_t focalLength = 1 / tan(angleOfView * 0.5 * M_PI / 180); //focal length calculate
        projectedVert.x = vertCamera.x  * focalLength / vertCamera.z;
        projectedVert.y = -vertCamera.y * focalLength / vertCamera.z; //added negative to invert image
